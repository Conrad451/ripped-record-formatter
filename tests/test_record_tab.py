...
# "Check my setup" (9.5)
# --------------------------------------------------------------------------- #
def _rec_idx_by_name(combo, name):
...
def test_setup_check_flags_192k_and_the_fix_sets_44100(qapp, no_hardware):
    ...
    tab.device_combo.setCurrentIndex(_rec_idx_by_name(tab.device_combo, "Line In"))  # 192000
...
def test_setup_check_listen_reports_no_signal(qapp, no_hardware):
    ...
    tab = MainWindow().record_tab
    tab.device_combo.setCurrentIndex(_rec_idx_by_name(tab.device_combo, "Line In"))
